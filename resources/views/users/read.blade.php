...
<div class="row">
        ...
        <div class="col-md-3 col-12 text-center">
            <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <li class="nav-item" class="{{ Request::is('users/*/read') ? 'active' : '' }}"><a href="{{ route('users.read_items', ['id' => $user->id]) }}" class="nav-link active"><i class="fas fa-bookmark"></i> READ <span class="badge badge-light">{{ $count_read }}</span></a></li>
    ...
    <div class="col-md-9 col-12 tab-content">
            @include('items.items', ['items' => $read_items])
             {!! $read_items->render() !!}
        </div>
</div>
@endsection