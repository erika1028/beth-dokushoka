  ...
  　<div class="main-part col-md-3 text-center float-left">
        ...
        <div class="name text-center">
            ...
            <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <li class="nav-item" ><a href="{{ Request::is('users/*/want') ? 'active' : '' }}"><a href="{{ route('users.want_items', ['id' => $user->id]) }}" class="nav-link active">WANT <span class="badge badge-light">{{ $count_want }}</span></a></li>
