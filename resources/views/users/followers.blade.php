  ...
  　<div class="main-part col-md-3 text-center float-left ">
        ...
        <div class="name text-center">
            ...
            <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <li class="nav-item" class="{{ Request::is('users/*/followers') ? 'active' : '' }}"><a href="{{ route('users.followers', ['id' => $user->id]) }}" class="nav-link active">Followers <span class="badge badge-light">{{ $count_followers }}</span></a></li>
           </ul>
    </div>
